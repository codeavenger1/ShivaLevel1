...
public class BookOfIllusions extends MouseAdapter {
	...
	JLabel label;
	String elephant = "elephant-illusion-test.jpg";
	String duckrab = "duckrabbitillusion.jpeg";
	...
	private void createBook() {
		...
		label = loadImageFromComputer(elephant);
	...
	public void mousePressed(MouseEvent e) {
		...
		label = loadImageFromComputer(duckrab);
		frame.add(label);
		// 14. pack the frame
		frame.pack();
	}
