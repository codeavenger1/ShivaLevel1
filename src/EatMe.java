...
private void makeAlbum() {
	...
	// this...
	images.put(new Integer(KeyEvent.VK_UP), "pudding.jpg"); // the spoon will be connected to the UP key
	images.put(new Integer(KeyEvent.VK_LEFT), "watermelon guy.jpg"); // the chopstick will be connected to the LEFT key
	images.put(new Integer(KeyEvent.VK_DOWN), "cheese.jpg");
	images.put(new Integer(KeyEvent.VK_RIGHT), "donuts.jpg");
...
public void keyPressed(KeyEvent e) {
	...
	if (whichKeyPressed == correctUtensilCode) {
		...
		JOptionPane.showMessageDialog(null, "Learn some manners you pig!");
	}
